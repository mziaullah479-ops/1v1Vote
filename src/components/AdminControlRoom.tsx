...
import { Person, PersonCategory, PersonCountry, PeopleAutomationStatus, PersonPromotion, PromotionRequest } from '../types';
...
export const AdminControlRoom: React.FC = () => {
  ...
  const load = async () => {
    const [peopleResponse, automationResponse, promotionResponse, requestResponse] = await Promise.all([
