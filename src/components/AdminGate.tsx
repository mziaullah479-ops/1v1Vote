...
export const AdminGate: React.FC<AdminGateProps> = ({ matches, onAddMatch, onEndMatch, onExit }) => {
  ...
  return (
    <div>
      ...
      <AdminPanel matches={matches} onAddMatch={onAddMatch} onEndMatch={onEndMatch} />
    </div>
  );
};
