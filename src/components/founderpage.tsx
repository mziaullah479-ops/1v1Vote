...
export const FounderPage: React.FC = () => {
  useEffect(() => {
    setPageSeo(
      'Muhammad Ziaullah - Founder of 1v1Vote',
      'Meet Muhammad Ziaullah, an independent developer and entrepreneur building practical, user-first digital products including 1v1Vote.',
      '/founder',
  ...
  return <main className="seo-shell min-h-screen px-4 py-8 text-slate-100 sm:px-6 sm:py-14">
    <div className="mx-auto max-w-4xl">
      ...
      <section className="seo-hero mt-8 rounded-[2rem] border border-sky-500/20 bg-gradient-to-br from-[#0d1b36] to-[#0a0e19] p-6 shadow-2xl sm:p-10">
        <div className="grid items-center gap-7 sm:grid-cols-[170px_1fr]">
          ...
          <div>
            <div className="flex items-center gap-2 text-xs font-black uppercase tracking-[0.2em] text-sky-300"><Sparkles className="h-4 w-4" /> Founder & independent developer</div>
            <h1 className="mt-4 text-3xl font-black tracking-tight text-white sm:text-5xl">Muhammad Ziaullah</h1>
            <p className="mt-3 text-lg font-bold text-sky-200">Developer, entrepreneur, and product builder</p>
            <p className="mt-4 max-w-3xl text-base leading-8 text-slate-300">Building practical, user-first web and mobile platforms that solve real problems.</p>
          </div>
        </div>
      </section>
      <div className="mt-6 grid gap-6 lg:grid-cols-[1.2fr_.8fr]">
        <article className="seo-article rounded-3xl border border-slate-800 bg-[#0b1221] p-6 sm:p-8">
          <h2 className="text-xl font-black text-white">About Muhammad</h2>
        ...
        <aside className="rounded-3xl border border-slate-800 bg-[#0b1221] p-6">
          <div className="flex items-center gap-2 text-sm font-black text-white"><ShieldCheck className="h-4 w-4 text-emerald-300" /> Founder principles</div>
      ...
      <p className="mt-6 text-center text-xs leading-6 text-slate-500">The project founder maintains the public directory and editorial standards. Profile corrections and source suggestions are reviewed through the contact route.</p>
    </div>
  </main>;
};
