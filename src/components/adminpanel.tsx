      ...
      <div className="bg-[#0b1324] border border-amber-500/40 rounded-3xl p-6 mb-8 shadow-xl">
        <div className="flex flex-wrap items-center justify-between gap-3 mb-2">
          ...
          <button
            ...
            className="flex items-center gap-2 rounded-xl border border-emerald-500/40 bg-emerald-950/40 px-3 py-2 text-xs font-bold text-emerald-300 hover:bg-emerald-900/50"
          >
