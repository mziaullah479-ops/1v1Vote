...
export const ThemeToggle: React.FC = () => {
  ...
  return (
    <button
      ...
      className="theme-toggle fixed right-4 top-4 z-[60] inline-flex min-h-11 items-center gap-2 rounded-full border border-sky-400/40 bg-white/95 px-3 py-2 text-xs font-black text-slate-800 shadow-xl shadow-slate-900/15 backdrop-blur transition hover:-translate-y-0.5 hover:border-sky-500 sm:bottom-4 sm:top-auto dark:bg-slate-900/95 dark:text-white"
    >
